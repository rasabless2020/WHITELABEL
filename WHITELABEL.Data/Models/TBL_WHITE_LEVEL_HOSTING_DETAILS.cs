namespace WHITELABEL.Data.Models
{
    ...
    public class TBL_WHITE_LEVEL_HOSTING_DETAILS
    {
        ...
        [StringLength(4, ErrorMessage = "Security pin must be 4 digit")]
        [RegularExpression("^[0-9]*$", ErrorMessage = "Security pin must be number")]
        public string HOSTING_SECURITYPIN { get; set; }
        [Required]
        [Display(Name = "Status")]
