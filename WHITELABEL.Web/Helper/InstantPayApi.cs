...
namespace WHITELABEL.Web.Helper
{
    public static class InstantPayApi
    {
        ...
        public static class MoneyTransferAPI
        {
            ...
            public static dynamic BeneficiaryRegistrationResendOTP(string remitterid, string beneficiaryid, string outletid)
            {
                try
                {
            ...
            public static dynamic BeneficiaryRegistrationValidate(string remitterid, string beneficiaryid, string otp,string outletid)
            {
                try
                {
            ...
            public static dynamic BeneficiaryDelete(string remitterid, string beneficiaryid,string outletid)
            {
                try
                {
            ...
            public static dynamic BeneficiaryDeleteValidate(string remitterid, string beneficiaryid, string otp,string outletid)
            {
                try
                {
            ...
            public static dynamic GetBankDetails(string account,string outletid)
            {
                try
                {
