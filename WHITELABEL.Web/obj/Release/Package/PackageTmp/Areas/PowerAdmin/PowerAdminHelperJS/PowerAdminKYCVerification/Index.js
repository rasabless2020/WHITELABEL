function Filedownload(filename, id) {
    ...
    $.ajax({
        ...
        url: '/PowerAdminKYCVerification/downloadfiles?area=PowerAdmin',
        type: 'GET',
        dataType: 'json',
        cache: false,
        ...
        callback: function (result) {
            if (result) {
                ...
                $.ajax({
                    ...
                    url: '/PowerAdminKYCVerification/ApproveKYCDocument?area=PowerAdmin',
                    data: {
        ...
        callback: function (result) {
            if (result) {
                ...
                $.ajax({
                    ...
                    url: '/PowerAdminKYCVerification/RejectKYCDocument?area=PowerAdmin',
                    data: {
                        __RequestVerificationToken: token,
                        id: id
                    },
