    ...
    $('#txtReferenceNumber').on('input blur change keyup', function () {
        ...
        if ($(this).val().length != 0) {
            ...
            $.ajax({
                ...
                url: '/SuperStockRequisition/CheckCouponReferenceNo?area=Distributor',
                data: {
...
function GerMerchantRequisitioninformation(transid) {
    var idval = transid;
    $.ajax({
        url: "/DistributorCouponManagment/getCouponReqMerchantTransdata?area=Distributor",
    ...
    bootbox.confirm({
        ...
        callback: function (result) {
            if (result) {
                ...
                var token = $(':input[name="__RequestVerificationToken"]').val();
                $.ajax({
                    url: "/DistributorCouponManagment/ApproveMerchantRequisitionStatus?area=Distributor",
    ...
    bootbox.confirm({
        ...
        callback: function (result) {
            if (result) {
                ...
                var token = $(':input[name="__RequestVerificationToken"]').val();
                $.ajax({
                    url: "/DistributorCouponManagment/RequisitionMerchantDecline?area=Distributor",
...
function printInvoiceOfDistributorDist(transid) {
    var idval = transid;
    $.ajax({
        url: "/DistributorCouponManagment/PrintDistributorcouponInvoice?area=Distributor",
        // url: "@Url.Action("getTransdata", "MemberRequisition", new {area="Admin"})",
        data: {
            TransId: transid
        },
