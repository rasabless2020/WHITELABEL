        ...
        bootbox.confirm({
            ...
            callback: function (result) {
                if (result) {
                    ...
                    $.ajax({
                        url: '/SuperService/UpdateActiveService?area=Super',
                        //url: "@Url.Action("UpdateActiveService", "StockistService", new {area= "SuperStockist" })",
                        data: {
...
$("#MemberList").change(function () {  
        ...
        var url = "/Super/SuperService/ServiceDetails?memid=" + MemberId;
        window.location = url;
       // alert(c);
    });
