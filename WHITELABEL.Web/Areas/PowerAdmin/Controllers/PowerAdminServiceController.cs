...
{
    [Authorize]
    public class PowerAdminServiceController : PoweradminbaseController
    {
        ...
        // GET: PowerAdmin/PowerAdminService
            ...
            if (Session["PowerAdminUserId"] != null)
            {
                try
                {
                    ...
                    if (memid != "")
                    {
                        ...
                        //var memberService = (from x in db.TBL_MASTER_MEMBER where x.UNDER_WHITE_LEVEL==0
                        //                     select new
                        //                     {
                        //                         MEM_ID = x.MEM_ID,
                        //                         UName = x.MEMBER_NAME
                ...
                {
                    Logger.Error("Controller:-  PowerAdminService(PowerAdmin), method:- ServiceDetails (GET) Line No:- 178", ex);
        ...
        public async Task<JsonResult> UpdateActiveService(string memberId, string Id, bool isActive)
        {
            ...
            using (System.Data.Entity.DbContextTransaction ContextTransaction = db.Database.BeginTransaction())
            {
                ...
                {
                    Logger.Error("Controller:-  PowerAdminService(PowerAdmin), method:- UpdateActiveService (POST) Line No:- 226", ex);
