    ...
    bootbox.confirm({
        ...
        callback: function (result) {
            if (result) {
                ...
                $.ajax({
                    //url: "@Url.Content("~/Service/UpdateActiveService")",
                    url: '/PowerAdminService/UpdateActiveService?area=PowerAdmin',
                    data: {
...
$("#MemberList").change(function () {
    ...
    var url = "/PowerAdmin/PowerAdminService/ServiceDetails?memid=" + MemberId;
    window.location = url;
    // alert(c);
});
