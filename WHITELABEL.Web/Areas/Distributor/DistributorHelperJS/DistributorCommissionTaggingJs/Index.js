var app = angular.module('DistributorCommissionSlabTagging', [])
app.controller('DistributorTagCommissionSlab', function ($scope, $http, $window, $location) {
    ...
    $scope.FetchOperator = function () {
        ...
        $http({
            url: '/DistributorCommissionTag/GetListInformation/',
            method: "POST",
    ...
    $scope.FetchOperatorByName = function (idval) {
        ...
        $http({
            url: '/DistributorCommissionTag/GetMemberListInformation/',
            method: "POST",
    ...
    $scope.EditValue = function (index) {
        ...
        $http({
            url: '/DistributorCommissionTag/fetchMemCommInfo/',
            method: "POST",
    ...
    $scope.SaveData = function () {
        ...
        $http({
            url: '/DistributorCommissionTag/SaveCommissionSlab',
            method: "POST",
            data: data
        }).then(function (response) {
            $scope.ServiceInformation = response.data;
            ...
            if (response.data.Result === "Success") {
                bootbox.alert({
                    ...
                    callback: function () {
                        var URL = "/Distributor/DistributorCommissionTag/Index/";
