...
var app = angular.module('DistributorCommissionSlabDistributionApp', [])
app.controller('DistributorCommissionSlabDistribution', function ($scope, $http, $window, $location) {
    $scope.SLN = 0;
    ...
    $scope.FetchOperator = function () {
        ...
        $http({
            url: '/DistributorCommissionSlab/GetServiceProvider/',
            method: "POST",
    ...
    $scope.SaveData = function () {
        ...
        $http({
            url: '/Distributor/DistributorCommissionSlab/AddCommissionSlab',
            method: "POST",
            data: data,
        }).then(function (response) {
            $scope.ServiceInformation = response.data;
            $('#Distributor_progress').hide();
            if (response.data.Result === "Success") {
                bootbox.alert({
                    message: "Commission Inserted Successfully..",
                    callback: function () {
                        var URL = "/Distributor/DistributorCommissionSlab/Index/";
    ...
    $scope.OnLoadDataBind = function () {
        ...
        $http({
            url: '/DistributorCommissionSlab/FetchData/',
            method: "POST",
