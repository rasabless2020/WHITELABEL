...
{
    [Authorize]
    public class SuperProfileUpdateController : SuperBaseController
    {
        ...
        public async Task<ActionResult> Index(ManageUserProfileDetails objval)
        {
            ...
            using (System.Data.Entity.DbContextTransaction ContextTransaction = db.Database.BeginTransaction())
            {
                ...
                catch (Exception ex)
                {
                    ...
                    Logger.Error("Controller:-  SuperProfileUpdate(Super), method:- Index (POST) Line No:- 145", ex);
