...
namespace WHITELABEL.Web.Areas.Admin.Controllers
{
    ...
    [Authorize]
    public class MemberKYCVerificationController : AdminBaseController
    {
        ...
        public void initpage()
        {
            try
            {
                ViewBag.ControllerName = "Member KYC";
        ...
        // GET: Admin/MemberKYCVerification
        ...
        public FileResult downloadfiles(string type, string memid)
        {
            ...
            {
                Logger.Error("Controller:-  MemberKYCVerification(Admin), method:- downloadfiles (GET) Line No:- 156", ex);
                throw ex;
            }
        ...
        public async Task<JsonResult> ApproveKYCDocument(string Id)
        {
            ...
            using (System.Data.Entity.DbContextTransaction ContextTransaction = db.Database.BeginTransaction())
            {
                ...
                {
                    Logger.Error("Controller:-  MemberKYCVerification(Admin), method:- ApproveKYCDocument (POST) Line No:- 193", ex);
